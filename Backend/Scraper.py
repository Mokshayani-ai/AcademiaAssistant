...
# Function to merge publications and fetch URLs for the first 10 papers with duplicates removal
def merge_publications_with_urls(google_scholar_pubs, dblp_pubs, author, limit=None):
    all_publications = []
    titles_seen = set()
